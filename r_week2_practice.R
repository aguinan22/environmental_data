...
plot(x = log(Animals$body), y = Animals$brain, ylab = "Animal brain" main = "dipliodocus is an outlier adn should not have been counted")
...
curve(
  line_point_slope(
    data_center_x, 
    data_center_y,
    abline(data_center_x, data_center_y), 
    add = FALSE)
...
plot(x = log(noMoredinos$body), y = noMoredinos$brain, main = "begone dinosaurs") 
